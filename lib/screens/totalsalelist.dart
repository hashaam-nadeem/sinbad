...
class TotalSaleList extends StatefulWidget {
  @override
  _VendorsListViewState createState() => _VendorsListViewState();
}

class _VendorsListViewState extends State<TotalSaleList> {
  ...
  Future<dynamic> _getVendorsData() async {
    ...
    var url = APIConstants.API_BASE_URL_DEV + APIOperations.NewProducts;
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              ...
              Text(
                translator.translate('Sale Products'),
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 18.0,
