import 'dart:async';
import 'package:brqtrapp/screens/change_password_screen.dart';
...
class Otpchanged extends StatefulWidget {
  final pinCode;
  ...
  @override
  _OtpchangedState createState() => new _OtpchangedState(pinCode, mobile);
}

class _OtpchangedState extends State<Otpchanged>
  ...
  _OtpchangedState(this.pinCode, this.mobile);
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          title: Text(translator.translate('Invalid OTP!')),
          content: Text(translator.translate('Please Enter Valid OTP!')),
          actions: <Widget>[
...
//                );
  ...
  _resendMobileNumber() async {
    // setState(() {
    //   _isLoading = true;
    // });
    final String apiURL = widget.emailType == true
        ? (APIConstants.API_BASE_URL_DEV + "/resetPasswordByemail")
        : (APIConstants.API_BASE_URL_DEV + "/resestPassword");
    Map<String, dynamic> userData = widget.emailType == true
        ? {
    ...
    if (jsonData['Status'] == true) {
      ...
      print("asdfasdfasdfasizdjfasdjiajdjdasdjasdjckasdjadsj");
      // setState(() {
      //   _isLoading = false;
      // });
